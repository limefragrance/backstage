...
import com.shenxiang.pojo.JsonResult;
...
//        String directory = simpleDateFormat.format(new Date());
        ...
        try {
            ...
            String url = request.getScheme() + "://" + request.getServerName() + ":" + request.getServerPort() + "/static/" + newFileName;
            log.info("图片上传，访问URL：" + url);
            //修改数据库中的位置
            UpdateWrapper<Admin> wrapper=new UpdateWrapper<>();
            wrapper.eq("username",username);
            wrapper.set("userimg",url);
